    ...
    const handleEmailAuth = async (e: React.FormEvent) => {
        ...
        try {
            if (mode === 'reset') {
                ...
                // Navigation will be handled by Login.tsx when auth state updates
            } else {
        ...
        <Card className="w-full max-w-md mx-auto">
            ...
            >
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <Input
                                ...
                                className="pl-11 h-12 bg-input/50 border-border/50 focus:border-primary/50 focus:ring-2 focus:ring-primary/20 transition-all"
                                required
                            />
                        </div>
                    </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input
                                    ...
                                    className="pl-11 pr-11 h-12 bg-input/50 border-border/50 focus:border-primary/50 focus:ring-2 focus:ring-primary/20 transition-all"
                                    required
                                    minLength={6}
                                />
                                <button
                ...
                {/* Divider */}
                {
                    ...
                    //                 disabled={loading}
                    //                 className="h-12 bg-secondary/30 border-border/50 hover:bg-secondary/50 hover:border-primary/30 transition-all duration-300"
                    //             >
            ...
            {/* Footer */}
            {/* <p
                className="text-center text-xs text-muted-foreground/60 mt-8 animate-fade-in-up"
